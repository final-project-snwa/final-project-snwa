...
- 목적: Spring 애플리케이션에 인공지능(LLM) 기능을 통합하기 위한 스타터
- 사용 위치: 멤버십 사용자 대상 챗봇 상담, 정산 데이터 요약 보고서 생성, 맞춤형 상품 추천 로직
- 비고: OpenAI의 API를 Spring 스타일의 추상화된 인터페이스로 사용할 수 있어 유지보수와 확장이 용이함
